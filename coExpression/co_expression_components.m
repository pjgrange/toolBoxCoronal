function coExpressionComponents = co_expression_components( coExpressionFull, options )
...
coExpressionComponents = struct( 'thresholds', thresholds, 'avgSizes', avgSizes, 'maxSizes', maxSizes, 'connectedIndices', connectedIndices );