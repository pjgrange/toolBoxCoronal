function coexprIsland = co_expr_island( coExpressionFull, options )

if nargin < 2
    options = struct( 'thresholdInit', 1, 'thresholdStep', 0.02, 'thresholdFinal', -1 );
end  
...
coexprIsland = struct( 'thresholds', thresholds, 'avgSizes', avgSizes, 'maxSizes', maxSizes, 'connectedIndices', connectedIndices );