function figureForTypes = figure_for_types( Ref, volumes, options )
...
for vv = 1 : numTypes
    ...
    set( hleg, 'Position', [ xPosProj( 6 ), bottomDist( vv ), widthParam, heightParam ], 'fontweight', 'b', 'fontsize', fontSizeAtlas, 'Color', 'w' );
...
axes('Position',[0 0 1 1],'Visible','off');
h = text( xPosProj( 1 )+0.07, 0.94, 'Sagittal projection', 'color', 'w', 'FontSize', fontSize -2, 'HorizontalAlignment','center');
h = text( xPosProj( 2 )+0.07, 0.94, 'Coronal projection', 'color', 'w', 'FontSize', fontSize -2, 'HorizontalAlignment','center');
h = text( xPosProj( 3 )+0.08, 0.94, 'Axial projection', 'color', 'w', 'FontSize', fontSize -2, 'HorizontalAlignment','center');
